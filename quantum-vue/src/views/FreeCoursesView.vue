<script setup>
    ...
    function getCourses(){
        // запрос курсов
        axios({
            url: 'https://admin.lk-quantum.ru/api/v1/course/free-courses',
    ...
    document.title = 'Каталог бесплатных курсов'
                    ...
                    <div class="card border-0">
                        <div class="card-body mt-5 pt-0">
                            ...
                            <div class="form-check mb-3">
                                <input v-model="free" type="checkbox" id="formCheck2" class="form-check-input" checked disabled>
