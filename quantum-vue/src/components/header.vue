      ...
      <ul class="navbar-nav">
        ...
        <div class="dropdown mx-4" id="themeSwitcher">
            <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">                
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="18" width="18">
                    <g>
                        ...
                        <path class="theme" d="M12,3.47a1,1,0,0,0,1-1V1a1,1,0,0,0-2,0V2.47A1,1,0,0,0,12,3.47Z"></path>
                        <path class="theme" d="M4.55,6a1,1,0,0,0,.71.29A1,1,0,0,0,6,6,1,1,0,0,0,6,4.55l-1-1A1,1,0,0,0,3.51,4.93Z"></path>
                        <path class="theme" d="M2.47,11H1a1,1,0,0,0,0,2H2.47a1,1,0,1,0,0-2Z"></path>
                        <path class="theme" d="M4.55,18l-1,1a1,1,0,0,0,0,1.42,1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29l1-1A1,1,0,0,0,4.55,18Z"></path>
                        <path class="theme" d="M12,20.53a1,1,0,0,0-1,1V23a1,1,0,0,0,2,0V21.53A1,1,0,0,0,12,20.53Z"></path>
                        <path class="theme" d="M19.45,18A1,1,0,0,0,18,19.45l1,1a1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.42Z"></path>
                        <path class="theme" d="M23,11H21.53a1,1,0,0,0,0,2H23a1,1,0,0,0,0-2Z"></path>
                        <path class="theme" d="M18.74,6.26A1,1,0,0,0,19.45,6l1-1a1,1,0,1,0-1.42-1.42l-1,1A1,1,0,0,0,18,6,1,1,0,0,0,18.74,6.26Z"></path>
                    </g>
                </svg>
            </a>
            ...
            <ul class="dropdown-menu dropdown-menu-start">
                ...
                <li>
                    <button type="button" class="dropdown-item active" data-theme-value="dark">
        ...
        <div class="dropdown">
            <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px show" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="true" data-bs-offset="0,0">
                <img src="../assets/images/profiles/student.png" alt="..." class="avatar-img" width="40" height="40">
            </a>

            <div class="dropdown-menu" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-7.2px, 40px, 0px);" data-popper-placement="bottom-end">

                <router-link to="/profile" class="dropdown-item">Профиль</router-link>
                <router-link to="/cart" class="dropdown-item">Корзина</router-link>
