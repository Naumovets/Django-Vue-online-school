...
class Task(models.Model):
    ...
    checkbox_answer_1 = models.CharField(max_length=255, verbose_name='Множественный ответ 1', null=True, blank=True)
    checkbox_answer_2 = models.CharField(max_length=255, verbose_name='Множественный ответ 2', null=True, blank=True)
    checkbox_answer_3 = models.CharField(max_length=255, verbose_name='Множественный ответ 3', null=True, blank=True)
    checkbox_answer_4 = models.CharField(max_length=255, verbose_name='Множественный ответ 4', null=True, blank=True)
    checkbox_answer_5 = models.CharField(max_length=255, verbose_name='Множественный ответ 5', null=True, blank=True)
